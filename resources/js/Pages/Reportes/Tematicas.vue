...
methods: {
  downloadPDF() {
    ...
    img.onload = function() {
        ...
        const chartWidth = 180; // Ancho del gráfico
        const chartHeight = 100; // Alto del gráfico
        ...
        pdf.save('ProyectosTematica.pdf');
    };

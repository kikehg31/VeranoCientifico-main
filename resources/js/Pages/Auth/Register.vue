<template >
  ...
  <div class="contenido">
    ...
    <div class="forma1">
      ...
      <div class="alumno" v-if="form.id_rol === 4"><br>
      ...
      <div class="revisor" v-if="form.id_rol === 3"><br>
      ...
      <div class="profesor2" v-if="form.id_rol === 2"><br>
        ...
        <div class="tipo">
          <div class="col-sm-5 mb-5">
              <jet-label class="label form-label fs-base" for="name" value="*Tipo de usuario" />
                <select required class="form-select form-select-lg" id="tipouser" :class="{'is-invalid':form.errors.id_rol}" v-model="form.id_rol">
          ...
          <div class="col-sm-4 mb-4" v-if="form.id_rol != 3 && form.id_rol != 2">
          ...
          <div class="col-sm-4 mb-5" v-if="form.id_rol === 2" >
          ...
          <div class="col-sm-4 mb-4" v-if="form.id_rol === 2" >
          ...
          <div class="col-sm-4 mb-5" >
                    ...
                    <jet-input placeholder="Teclee su contraseña" type="password" id="password" class="form-control form-control-lg" required v-model="form.password"  :class="{ 'is-invalid': form.errors.password }" />
          ...
          <div class="col-sm-4 mb-2" >
                    ...
                    <jet-input placeholder="Teclee Nuevamente su Contraseña" type="password" id="password" required class="form-control form-control-lg" v-model="form.password_confirmation"  :class="{ 'is-invalid': form.errors.password_confirmation }" />
          ...
          <div class="col-sm-8 mb-2" v-if="form.id_rol === 2" >
          ...
          <div class="col-sm-8 mb-2" v-if="form.id_rol === 3" >
...
export default{
  ...
  setup(props) {
    ...
    const form = useForm({
      ...
      const guardar = () => {
        if(form.id_rol == "4" && form.name != "" && form.lastnamep != "" && form.lastnamem != "" && form.curp != "" && form.email != "" && form.emailcon != "" && form.phone != "" && form.institution_id != "" && form.password != "" && form.password_confirmation != ""){
        ...
        }else if (form.id_rol == "2" && form.name != "" && form.lastnamep != "" && form.lastnamem != "" && form.curp != "" && form.email != "" && form.emailcon != "" && form.phone != "" && form.institution_id != "" && form.password != "" && form.password_confirmation != "" && form.thematic_id != "" && form.subthematic_id != "" && form.maxgrade != "" && form.invline != "" && form.snilevel != ""&& form.constancy != ""){
          const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
              confirmButton: 'btn btn-success',
              cancelButton: 'btn btn-danger'
        ...
        }else if(form.id_rol == "3" && form.name != "" && form.lastnamep != "" && form.lastnamem != "" && form.curp != "" && form.email != "" && form.emailcon != "" && form.phone != "" && form.institution_id != "" && form.password != "" && form.password_confirmation != "" && form.requestform != ""){
          const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
              confirmButton: 'btn btn-success',
              cancelButton: 'btn btn-danger'
